...
- [ ] **Still open:** Ubuntu 24.04 **desktop** AppImage recording/safeStorage smoke (2026-08-28 evidence is Docker with `fuse3` + `/dev/fuse`, no fuse2 — not a Ubuntu desktop). Linux artifacts are enabled in the release workflow after Gate B closed.
