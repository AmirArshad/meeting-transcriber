...
- [ ] **Still open:** Ubuntu 24.04 **desktop** AppImage recording/safeStorage smoke (2026-08-28 evidence is Docker with `fuse3` + `/dev/fuse`, no fuse2 — not a Ubuntu desktop). Gate B still blocks attaching Linux artifacts to GitHub Releases.
