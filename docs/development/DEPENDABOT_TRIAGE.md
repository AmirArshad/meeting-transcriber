...
Last reviewed: 2026-08-28 (Task 3 macOS pin trim **rejected**). Prior: 2026-08-28 (Task 2 macOS Numba 0.67.0 / llvmlite 0.49.0). Prior: 2026-08-28 (Task 2 macOS torch 2.13.0 + setuptools 84.0.0). Prior: 2026-08-28 (Task 2 setuptools 84.0.0 Windows/Linux build pin). Prior: 2026-08-28 (Task 2 PyAV 18.1.0). Prior: 2026-08-28 (FileLock Linux correction + matrix). Prior: 2026-08-13. Absorbed #73 (`filelock`/`certifi`), #72 (`typing-extensions`), and #58 (`ctranslate2` 4.8.1) on `chore/deps-filelock-certifi-typing-ctranslate2`. Prior: 2026-07-14 on `chore/dependency-hygiene`.
