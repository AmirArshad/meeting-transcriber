...
## Archived root `todo.md` snapshot (2026-03-12 review reset)

This is the verbatim root `todo.md` content that was replaced when the active checklist
was reset to track the latest unresolved MR review findings.
