...
Planned or active future work lives here. Completed designs should move to `../completed/` after implementation (or stay here with a clear **Complete** status when they remain useful as maintainer reference).
