...
Planned or active future work lives here. Completed designs should move to `../completed/` after implementation.

- [Roadmap](ROADMAP.md)
- [Aurison codebase refactor](AURISON_CODEBASE_REFACTOR.md)
