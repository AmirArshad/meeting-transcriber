...
> Historical note: this audit reflects repo state from December 2025 and is not a live source of truth for current product behavior. For current recorder/build behavior, use `README.md`, `docs/development/*.md`, `docs/completed/json-based-events.md`, and `docs/completed/FULL_AUDIT_REMEDIATION_ARCHIVE.md`.
