...
Branch: `refactor/codebase-phase-7b` (Phase 7 PR B: macOS diagnostics/stereo repair + Swift PCM/status helpers; after merged Phase 7 PR A #43).
...
- [x] [Risk: High] Phase 7: narrow recorder/Swift helper extractions only.
  ...
  - [x] PR B: `macos_stereo_repair.py`, `macos_desktop_diagnostics.py`, `swift_pcm_alignment.py`, `swift_helper_status.py` behind thin re-exports/delegates (thresholds + stdout contracts unchanged).
