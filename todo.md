...
- [x] [Risk: High] Create `feature/v2.9-linux-ai-addons` after the accepted Electron 44 and reliability lanes. Task 1 recorded fresh official artifact/license/hash evidence and the CachyOS + RTX 4070 preflight for CUDA Whisper, Speakrs, Pyannote, and summaries in [`V2_9_DEPENDENCY_COMPATIBILITY.md`](docs/development/V2_9_DEPENDENCY_COMPATIBILITY.md). CUDA Whisper moves to its managed-runtime gate; Speakrs, Pyannote, and summaries remain unavailable until their independent gates pass. Use [`2026-09-01-v2.9-linux-ai-addons.md`](docs/superpowers/plans/2026-09-01-v2.9-linux-ai-addons.md); do not enable a component before its own gate passes.
