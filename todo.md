...
1. **Linux support (Omarchy first)** — execute [docs/initiatives/LINUX_SUPPORT.md](docs/initiatives/LINUX_SUPPORT.md) Phases 0–5 (Core Beta / first Linux version). Speaker identification and summaries stay greyed `unsupported`. Do not start Phases 6–9 until an Omarchy + NVIDIA host exists. Gate A resolved; Gate B still blocks release-workflow changes.
