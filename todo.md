...
- [ ] [Risk: High] On Windows/Linux, bump stale `requirements-*-build.txt` pins to current resolve (keep the lock; do not float). Clusters 1–2 accepted 2026-08-29: huggingface-hub 1.29.0 + transitives; typer 0.27.2 / drop unused Linux colorama / keep click. Remaining: leftover floats protobuf / Pygments / annotated-doc. `filelock` stays 3.32.3. Do not bump `onnxruntime` 1.26.0.
