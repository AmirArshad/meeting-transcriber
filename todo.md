...
- [ ] [Risk: Medium] Task 2 on this Windows PC: pytest 9.1.1; PyAV 18.1.0 after Windows/Linux packaged decode smoke; setuptools 84 on Windows/Linux build files only. Separate commits. See the matrix.
