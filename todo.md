...
- [ ] [Risk: Medium] Task 2 on this Windows PC: pytest 9.1.1 **done**; PyAV 18.1.0 **done**; remaining setuptools 84 on Windows/Linux build files only. Separate commits. See the matrix.
