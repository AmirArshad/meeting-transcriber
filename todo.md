...
- [ ] [Risk: High] **Task 7 — soak on merged builds + cutover:** flip `DIARIZATION_ENGINE` to `'speakrs'` + update `AGENTS.md` **and README RAM** (speaker ID **8 GB min / 16 GB recommended** — 0a CLI was 3.81 GB; finalize after 0b Windows RSS); benchmark matrix → `docs/development/SPEAKRS_BENCHMARKS.md`; bar = ≥25 meetings (≥10/OS), 2×50-turn A/B ≤ +2 vs pyannote, checklist green on packaged Windows CUDA + macOS AS.
